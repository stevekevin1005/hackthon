    ...
    <body class="c-layout-header-fixed c-layout-header-mobile-fixed">
        ...
        <div class="c-layout-page">
          <img src="assets/base/img/content/stock3/15.jpg" alt="" style="width:100%; margin-top:-820px">
            ...
            <div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
                <div class="container">
                    <div class="c-page-title c-pull-left">
                        <h3 class="c-font-uppercase c-font-sbold">市政團隊介紹</h3>
                    </div>
                    <ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                        <li>
                            <a href="#department1">本府各處及所屬一級機關</a>
                        </li>
                        <li>/</li>
                        <li>
                          <a href="#department2">區公所及所屬一級機關</a>
                        </li>
                        <li>/</li>
                        <li>
                          <a href="#department3">相關機關(單位)</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="c-content-box c-size-md c-overflow-hide c-bs-grid-small-space c-bg-grey-1" id="department1">
                <div class="container">
                    <div class="c-content-title-4">
                        <h3 class="c-font-uppercase c-center c-font-bold c-line-strike">
                            <span class="c-bg-grey-1">本府各處及所屬一級機關</span>
                        </h3>
                    </div>
                    <div class="row">
