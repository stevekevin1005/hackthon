				...
				<div class="c-navbar-wrapper clearfix">
						<div class="c-brand c-pull-left">
								<a href="index.html" class="c-logo">
										<img src="assets/base/img/layout/logos/logo-1.png" alt="新竹市政府" class="c-desktop-logo">
						...
						<nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-theme c-fonts-uppercase c-fonts-bold">
								<ul class="nav navbar-nav c-theme-nav">
										<li class="c-active">
												<a href="javascript:;" class="c-link dropdown-toggle">網頁導覽
												</a>
										</li>                                
										...
										<li class="c-menu-type-classic">
												<a href="javascript:;" class="c-link dropdown-toggle">公告資訊
														<span class="c-arrow c-toggler"></span>
												</a>
												<ul class="dropdown-menu c-menu-type-classic c-pull-left">
														<li class="dropdown-submenu">
																<a href="javascript:;">市政新聞
																		<span class="c-arrow c-toggler"></span>
																</a>
														</li>
														<li class="dropdown-submenu">
										...
										<li>
												<a href="javascript:;" class="c-link dropdown-toggle">市府介紹
														<span class="c-arrow c-toggler"></span>
												</a>
												<ul class="dropdown-menu c-menu-type-classic c-pull-left">
														<li class="dropdown-submenu">
										...
										<li>
												<a href="javascript:;" class="c-link dropdown-toggle">主題服務
														<span class="c-arrow c-toggler"></span>
												</a>
												<ul class="dropdown-menu c-menu-type-mega" style="min-width: auto">
														<li>
										...
										<li>
												<a href="javascript:;" class="c-link dropdown-toggle">徵才專區
														<span class="c-arrow c-toggler"></span>
												</a>
										</li>
